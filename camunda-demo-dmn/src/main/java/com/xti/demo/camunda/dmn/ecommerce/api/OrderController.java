...
public class OrderController {
    ...
    public ResponseEntity<GenericResult> register(@PathVariable(name="previousOrders") Integer previousOrders, @PathVariable(name="daysSinceFirstOrder") Integer daysSinceFirstOrder, @PathVariable(name="valueOfOrder") Integer valueOfOrder, Model model) {
    	...
    	return new ResponseEntity<GenericResult>(new OrderHandlingResult(gift, label), HttpStatus.OK);
    }
